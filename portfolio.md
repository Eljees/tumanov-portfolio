...
**Финал конкурса «Своё дело»**, МИЭМП, Москва, 18 мая 2011 — защита проекта (бизнес-план и презентация), заявка от НИЯУ МИФИ. Не конференция, а конкурс предпринимательских проектов; освещался в новостях МИЭМП.
...
*Требует уточнения:* к какому событию относится презентация «Туманов_Сколково.ppt». В переписке за 2012 год — Открытый университет Сколково совместно с Microsoft («ЗаPush свой проект», октябрь 2012), вебинары фонда и рассылки Зворыкинского проекта.
...
**«Тесное окно: промпт-инжиниринг для локального триажа уязвимостей на одной видеокарте»** — журнал «Хакер», рубрика «Кодинг». Тема согласована с главным редактором 24 июня 2026 с условием, что текст пишет человек, без признаков стиля LLM. Статья в работе; готовы карточка статьи и несколько редакций текста.
